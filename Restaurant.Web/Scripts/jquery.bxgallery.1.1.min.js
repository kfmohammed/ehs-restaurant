...
(function ($) {
    $.fn.extend({ bxGallery: function (options) {
        ...
        function preload_img() {
            ...
            $orig.parent().find('#loading').css({ 'textAlign': 'left', 'margin-left': '10px', 'width': o.maxwidth });
        ...
        function set_layout() {
            ...
            $outer = $orig.parent();
            //$orig.find('li').css({ 'position': 'static' });
            $orig.find('li').css({ 'padding': '0px 0 25px 0' });
        }
        ...
        function set_main_img() {
            $orig.find('img').each(function () {
                ...
                if (o.maxwidth != '') {
                    if ($this.width() > o.maxwidth) {
                        $this.width(o.maxwidth); $this.height(($imgheight / $imgwidth) * o.maxwidth);
                    }
                }
            ...
            $orig.height(tall);
            $orig.width(wide);
            //$orig.parent().find('ul').css({ 'border': '1px solid #ddd' });
